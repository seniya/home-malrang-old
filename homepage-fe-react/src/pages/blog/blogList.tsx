...
import listDefaultImage from '../../assets/images/list-default-image.png';
      ...
      <List
        ...
        renderItem={(item) => (
          <List.Item
            key={item.id}
            actions={[
              <Space key="list-vertical-love-o">
                <HeartTwoTone twoToneColor="#eb2f96" />
                {156}
              </Space>,
              <Space key="list-vertical-date-o">
                <ClockCircleOutlined />
            ...
            extra={
              item.attachment !== null ? (
                <Image
                  width={150}
                  src={`/api/attachments/image/${item.attachment?.id}`}
